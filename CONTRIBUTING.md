...
Development requires the Kubernetes CLI tool as well as a local Kubernetes cluster. [K3D](https://k3d.io/v5.6.3/) is recommended as a lightweight local option for standing up Kubernetes clusters.
...
5. During this time, ensure that all new commits are rebased into your branch so that it remains up to date with the `development` branch.
